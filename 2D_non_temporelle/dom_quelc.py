...
inverted_jet = ListedColormap(list(reversed(cm.jet(np.linspace(0, 1, 256)))))
...
Lz=0.003
m=3 # Nombre de bronches ou membranes
a=int(n/2)
b=int((2/10) * n)
c=int((5/10) * n)
d=int((2/10) * n)
...
mes_couleurs=['white','blue','green','yellow','orange','red']
...
vmax=C_0
step=0.1
mesh=plt.pcolormesh(Z, Y, z, cmap=inverted_jet, vmin=0, vmax=C_0-C_b)  # You can also use plt.pcolormesh for a different style
